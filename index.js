...
// Property of itsP33t on github. This script is a fork of EasyFivem by itsP33t
...
Everything except the name should be the same
--------------------------------------------
...
// Start
console.log(boxen(`Current version: ${chalk.yellow(ver)}
${chalk.green('You can import your own projects, just import the folder to')} ${chalk.gray(`${addonLoc}`)}`, {title: `Zenet official CLI`, titleAlignment: 'center', borderColor: 'white', borderStyle: 'round'}))
console.log(`${chalk.blue('Select the template you want to use. Use arrows to select and enter to confirm',)}`)
...
if (!fs.existsSync(path.join(ScriptLocation, '/addon'))) {
  console.log(chalk.red("addon folder not found, try reinstalling the Zenet CLI, if it still doesn't work, create an issue on github"))
  process.exit()
}
